      ...
      <style>
        ...
        * {
        ...
        .play-btn {
            ...
            min-width: 30px;
            height: 30px;
            background: url("https://raw.githubusercontent.com/beforesemicolon/BFS-Projects/audio-player-tag/audio-player/audio-player-icon-sprite.png") 0 center/500% 100% no-repeat;
            appearance: none;
            border: none;
        ...
        .play-btn.playing {
            background: url("https://raw.githubusercontent.com/beforesemicolon/BFS-Projects/audio-player-tag/audio-player/audio-player-icon-sprite.png") 25% center/500% 100% no-repeat;
        }
        ...
        .volume-bar {
            ...
            min-width: 30px;
            height: 30px;
            background: url("https://raw.githubusercontent.com/beforesemicolon/BFS-Projects/audio-player-tag/audio-player/audio-player-icon-sprite.png") 50% center/500% 100% no-repeat;
            position: relative;
        }

        .volume-bar.half {
            background: url("https://raw.githubusercontent.com/beforesemicolon/BFS-Projects/audio-player-tag/audio-player/audio-player-icon-sprite.png") 75% center/500% 100% no-repeat;
        }
        .volume-bar.over {
            background: url("https://raw.githubusercontent.com/beforesemicolon/BFS-Projects/audio-player-tag/audio-player/audio-player-icon-sprite.png") 100% center/500% 100% no-repeat;
        }
